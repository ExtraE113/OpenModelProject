function handleChange() {
    ...
    let data = {
        ...
        "xspx": [0.51, 0.53, "Ossoff margin: 0.3 (80% CI: -3.6 to 4.1)", 0.62, "Warnock margin: 1 (80% CI: -2.9 to 4.8)"],
        "cspx": [0.39, 0.4, "Ossoff margin: -0.9 (80% CI: -4.8 to 3)", 0.49, "Warnock margin: -0.2 (80% CI: -4.1 to 3.7)"],
        "xwpx": [0.62, 0.69, "Ossoff margin: 1.8 (80% CI: -2.1 to 5.6)", 0.7, "Warnock margin: 1.8 (80% CI: -2 to 5.7)"],
        "cwpx": [0.48, 0.54, "Ossoff margin: 0.4 (80% CI: -3.5 to 4.2)", 0.56, "Warnock margin: 0.4 (80% CI: -3.4 to 4.3)"],
        ...
        "xspe": [0.41, 0.42, "Ossoff margin: -0.8 (80% CI: -4.6 to 3.1)", 0.52, "Warnock margin: 0 (80% CI: -3.8 to 3.9)"],
        "cspe": [0.35, 0.36, "Ossoff margin: -1.3 (80% CI: -5.2 to 2.5)", 0.45, "Warnock margin: -0.5 (80% CI: -4.4 to 3.3)"],
        "xwpe": [0.47, 0.5, "Ossoff margin: 0 (80% CI: -3.9 to 3.8)", 0.56, "Warnock margin: 0.5 (80% CI: -3.4 to 4.3)"],
        "cwpe": [0.4, 0.42, "Ossoff margin: -0.7 (80% CI: -4.6 to 3.1)", 0.48, "Warnock margin: -0.2 (80% CI: -4.1 to 3.6)"]
    }
